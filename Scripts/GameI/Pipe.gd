...
func _on_DetP1_area_exited(_area):
	if GCD.Alive1:
		GCD.ScP1 += 1


func _on_DetP2_area_exited(_area):
	if GCD.Alive2:
		GCD.ScP2 += 1


func _on_DetP3_area_exited(_area):
	if GCD.Alive3:
		GCD.ScP3 += 1


func _on_DetP4_area_exited(_area):
	if GCD.Alive4:
		GCD.ScP4 += 1


func _on_DetSolo_area_exited(_area):
	if GCD.AliveS:
		GCD.ScSolo += 1
